    ...
    tariffs: [
      {
        ...
        description:
          'расчет договорной контрактной цены для заключения договора строительного подряда и для участия в торгах или переговорах, составление сметной документации, отчетной документации по факту выполненных работ по согласованному перечню до 3 объектов.',
        features: [
          'До 3 объектов',
      ...
      },
      {
        ...
        description:
          'расчет договорной контрактной цены для заключения договора строительного подряда и для участия в торгах или переговорах, составление сметной документации, отчетной документации по факту выполненных работ по согласованному перечню от 3 объектов.',
        features: [
          'От 3 объектов',
          'Расчет договорной цены',
          'Составление сметной документации',
      ...
      },
      {
        ...
        description:
          'абонентское сметное обслуживание исходя из фактически обработанных часов по согласованному перечню: расчет договорной контрактной цены для заключения договора строительного подряда и для участия в торгах или переговорах, составление сметной документации, отчетной документации.',
        features: [
          'Почасовая оплата',
          'Гибкий график',
          'Расчет договорной цены',

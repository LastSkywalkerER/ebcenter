...
const services = [
  {
    ...
    description: 'Сметное обслуживание для строительных организаций',
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      'Составление отчётной документации - актов сдачи-приёмки выполненных работ, оформление справок, составление актов на дополнительные работы',
    icon: (
      <svg
        className='w-12 h-12 text-blue-600'
        fill='none'
  ...
  },
  {
    ...
    description:
      'Составление отчётной документации для организаций, выполняющих работы собственными силами',
    icon: (
      <svg
        className='w-12 h-12 text-blue-600'
        fill='none'
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Услуги в сфере строительства и проектирования
            </p>
          </div>
